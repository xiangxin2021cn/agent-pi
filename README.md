...
**Agent π 1.1.2 已正式发布。** 这是基于 Craft Agents OSS 深度改造的 Windows 桌面智能体工作台，面向长周期项目分析、招投标文件处理、工程资料研究、多模型协同和可追溯成果沉淀。
...
[下载 Agent π 1.1.2 Windows 安装包](https://github.com/xiangxin2021cn/agent-pi/releases/latest)
...
V1.1.2 先完成任务契约和 Document Plan 底座，后续路线会从“会写内容”继续升级为“会生产正式文件”。详细计划见 [Professional Document Workbench Roadmap](docs/PROFESSIONAL_DOCUMENT_WORKBENCH.md)。
