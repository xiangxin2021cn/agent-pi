...
External apps can navigate using `agentpi://` URLs:

```
agentpi://settings
agentpi://allSessions/session/session123
agentpi://sources/source/github
agentpi://action/new-chat
agentpi://workspace/{id}/allSessions/session/abc123
```
