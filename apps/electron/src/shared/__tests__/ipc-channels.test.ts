...
const EXPECTED_CHANNELS: string[] = [
  ...
  'browser-pane:stop',
  'businessProjects:create',
  'businessProjects:list',
  'businessProjects:unregister',
  'businessProjects:updateInputs',
  ...
  'debug:log',
  'deeplink:navigate',
  'deliveryWorkspace:get',
  'deliveryWorkspace:list',
  'deliveryWorkspace:mutate',
  'dialog:openFolder',
  'drafts:delete',
  'drafts:get',
  'drafts:getAll',
  ...
  'input:setSpellCheck',
  'investmentWorkspace:get',
  'investmentWorkspace:list',
  'investmentWorkspace:mutate',
  'labels:changed',
  'labels:create',
  'labels:delete',
  'labels:list',
  ...
  'sessions:command',
  'sessions:create',
  'sessions:createFileMemorySource',
  'sessions:delete',
  'sessions:export',
  ...
  'sessions:getNotes',
  'sessions:getOutputDirectory',
  'sessions:getPendingPlanExecution',
  'sessions:getPermissionModeState',
  'sessions:getProjectMemoryStatus',
  'sessions:getUnreadSummary',
  'sessions:import',
  'sessions:importRemoteTransfer',
  'sessions:killShell',
  'sessions:markAllRead',
  'sessions:optimizePrompt',
  'sessions:promoteFile',
  'sessions:resetProjectMemoryQualityTelemetry',
  ...
  'tasks:getOutput',
  'tenderWorkspace:get',
  'tenderWorkspace:list',
  'tenderWorkspace:mutate',
  'tenderWorkspace:stageRun',
  'theme:appChanged',
  ...
  'workspaceSettings:mineruCredentialStatus',
  'workspaceSettings:saveMineruToken',
