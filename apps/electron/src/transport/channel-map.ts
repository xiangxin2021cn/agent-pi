...
export const CHANNEL_MAP = {
  ...
  getSessionMessages: invoke(RPC_CHANNELS.sessions.GET_MESSAGES, undefined, { timeoutMs: 20_000 }),
  ...
  getLlmConnectionVisionApiKey: invoke(RPC_CHANNELS.llmConnections.GET_VISION_API_KEY),
