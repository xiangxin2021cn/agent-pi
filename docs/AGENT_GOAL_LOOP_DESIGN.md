...
- When required evidence criteria explicitly ask to cite source material, and source file evidence is available, a final response without any source citation marker fails before reviewer approval.
...
- Did requested tests/build/typechecks run?
