...
async function getProjectMemoryStatusForWorkingDirectory(
  ...
  const entryCount = await countJsonlEntries(entriesPath)
  return {
    status: 'lite_ready',
    message: 'Project Memory Lite is refreshed.',
    workingDirectory,
    projectBrainPath: brainPath,
...
export const HANDLED_CHANNELS = [
  ...
  RPC_CHANNELS.sessions.GET_PROJECT_MEMORY_STATUS,
  RPC_CHANNELS.sessions.PROMOTE_FILE,
  RPC_CHANNELS.sessions.CREATE_FILE_MEMORY_SOURCE,
  RPC_CHANNELS.sessions.RESET_PROJECT_MEMORY_QUALITY_TELEMETRY,
