...
/**
 * Agent Pi config files that have known schemas.
 */
const CRAFT_AGENT_CONFIG_PATTERNS = [
  // Main config
  /\.(?:agent-pi|craft-agent)\/config\.json$/,
  // Preferences
  /\.(?:agent-pi|craft-agent)\/preferences\.json$/,
  // Source configs
  /\.(?:agent-pi|craft-agent)\/workspaces\/[^/]+\/sources\/[^/]+\/config\.json$/,
  // Permissions
  /\.(?:agent-pi|craft-agent)\/workspaces\/[^/]+\/permissions\.json$/,
  /\.(?:agent-pi|craft-agent)\/permissions\/[^/]+\.json$/,
  // Theme
  /\.(?:agent-pi|craft-agent)\/workspaces\/[^/]+\/theme\.json$/,
  // Statuses
  /\.(?:agent-pi|craft-agent)\/workspaces\/[^/]+\/statuses\/config\.json$/,
  // Labels
  /\.(?:agent-pi|craft-agent)\/workspaces\/[^/]+\/labels\.json$/,
  // Tool icons
  /\.(?:agent-pi|craft-agent)\/tool-icons\/tool-icons\.json$/,
];
