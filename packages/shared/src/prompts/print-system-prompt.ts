...
const systemPrompt = getSystemPrompt(
  ...
  '/Users/example/.agent-pi/workspaces/abc123' // Example workspace path
);
...
const systemPromptWithDebug = getSystemPrompt(
  undefined,
  { enabled: true, logFilePath: '~/Library/Logs/@agent-pi/electron/main.log' },
  '/Users/example/.agent-pi/workspaces/abc123'
);
...
const sessionState = formatSessionState('260121-example-session', {
  plansFolderPath:
    '/Users/example/.agent-pi/workspaces/abc123/sessions/260121-example-session/plans',
});
