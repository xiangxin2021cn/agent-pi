 ...
 *
 * Watched paths:
 * - ~/.agent-pi/config.json - Main app configuration
 * - ~/.agent-pi/preferences.json - User preferences
 * - ~/.agent-pi/theme.json - App-level theme overrides
 * - ~/.agent-pi/themes/*.json - Preset theme files (app-level)
 * - ~/.agent-pi/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.agent-pi/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.agent-pi/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.agent-pi/permissions/)
