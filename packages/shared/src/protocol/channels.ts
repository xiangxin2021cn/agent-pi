...
export const RPC_CHANNELS = {
  ...
  investmentWorkspace: {
    LIST: 'investmentWorkspace:list',
    GET: 'investmentWorkspace:get',
    MUTATE: 'investmentWorkspace:mutate',
  },
  businessProjects: {
    LIST: 'businessProjects:list',
    CREATE: 'businessProjects:create',
    UPDATE_INPUTS: 'businessProjects:updateInputs',
    UNREGISTER: 'businessProjects:unregister',
  },
  workspaces: {
    GET: 'workspaces:get',
  ...
  file: {
    READ: 'file:read',
    READ_PREVIEW: 'file:readPreview',
    READ_SPREADSHEET_PREVIEW: 'file:readSpreadsheetPreview',
    ...
    OPEN_ATTACHMENT_DIALOG: 'file:openAttachmentDialog',
  ...
  llmConnections: {
    ...
    GET_VISION_API_KEY: 'LLM_Connection:getVisionApiKey',
