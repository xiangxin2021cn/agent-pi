 ...
 * Default location: ~/.agent-pi/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.agent-pi/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.agent-pi/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.agent-pi/workspaces/
 */
